...
from preprocessing.event_trigger.dependency_parser import get_dependencies, show_dependencies
from preprocessing.event_trigger.ner import get_named_entites
...
class EventExtractor(object):
    ...
    def __init__(self, dataset_name: str = "roc",
                 ...
                 output_dir=f"{BASE_DIR}/resources/datasets/event-trigger/roc-stories",
    ...
    @property
    def event_triggers_size(self):
        triggers = set([event.event_trigger for event in self.event_graph.events.values()])
        return len(triggers)
